...
from legal_draft_agent.models import (
...
from legal_draft_agent.ingestion.processor import DocumentProcessor
from legal_draft_agent.retrieval.vector_store import VectorStore
from legal_draft_agent.generation.drafter import Drafter
from legal_draft_agent.feedback.learner import Learner
...
if os.path.exists(UI_DIR):
    ...
    async def ui_not_found():
        return {"message": "Legal Draft Agent API is running. UI assets not found in package. Use 'npm run build' in the ui directory and copy 'out' to 'src/legal_draft_agent/ui' to enable the web interface."}
